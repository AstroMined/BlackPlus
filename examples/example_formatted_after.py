"""This is a properly formatted module docstring.

It should follow the Google Style Guide.
"""
...
def function_with_long_parameter_descriptions(
    param1: str,
    param2: str,
    param3: str,
):
    ...
    Args:
        ...
        param2: This is another long description for the second parameter that
...
def function_without_docstring(param1, param2):
    """Function without original docstring.
