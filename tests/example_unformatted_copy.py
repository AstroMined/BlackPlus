...
Parameters:
radius (float): The radius of the circle for which the area will be
calculated
...
def complex_function(x, y):
    """Performs a complex calculation on two numbers and returns the result
which includes addition, subtraction, multiplication, and division.
